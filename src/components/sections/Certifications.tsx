    ...
    return (
        <section id="certifications" className="relative bg-(--bg) py-32 px-6 lg:px-10 overflow-hidden">
            ...
            // professional recognition
                    ...
                    >
                        A collection of certifications and credentials that validate my expertise in building scalable, modern, and high-performance applications.
                    </motion.p>
                </div>
                        ...
                        >
                            ...
                            <div className="grid grid-cols-2 gap-4 mb-8">
                                <div className="flex flex-col gap-1">
                                    <span className="font-mono text-[9px] uppercase tracking-widest text-muted">Issued</span>
                                ...
                                <div className="flex flex-col gap-1">
                                    <span className="font-mono text-[9px] uppercase tracking-widest text-muted">Credential ID</span>
