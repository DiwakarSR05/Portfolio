...
const marquee = ["React", "TypeScript", "Next.js", "Node", "Postgres", "Prisma", "Tailwind", "Framer Motion", "Docker", "AWS", "Redis", "GraphQL", "Three.js"];
    ...
    <section id="skills" className="relative py-32 px-6 lg:px-10 overflow-hidden">
      ...
      <div className="mt-24 relative">
        <div className="overflow-hidden">
          <div className="marquee flex whitespace-nowrap font-display font-bold text-[var(--surface)]/[0.06]"
               style={{ fontSize: "clamp(60px, 10vw, 140px)" }}>
            {[...marquee, ...marquee].map((m, i) => (
              <span key={i} className="px-8">{m} ·</span>
            ))}
          </div>
        </div>
        <div className="overflow-hidden mt-4">
          <div className="marquee-reverse flex whitespace-nowrap font-display font-bold text-[var(--primary)]/[0.08]"
               style={{ fontSize: "clamp(60px, 10vw, 140px)" }}>
