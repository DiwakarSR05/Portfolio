    ...
    <div className="flex min-h-screen items-center justify-center bg-[var(--bg)] px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6">
          <Link
            to="/"
            className="inline-flex items-center justify-center rounded-full bg-[var(--primary)] px-5 py-2.5 text-sm font-medium text-[var(--ink)]"
          >
            Go home
          </Link>
        </div>
...
function ErrorComponent({ error, reset }: { error: Error; reset: () => void }) {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[var(--bg)] px-4">
      <div className="max-w-md text-center">
        <h1 className="font-display text-xl font-semibold text-[var(--ink-light)]">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          ...
          <a
            href="/"
            className="rounded-full border border-[var(--border)] px-5 py-2.5 text-sm font-medium text-[var(--ink-light)]"
          >
            Go home
          </a>
        </div>
  ...
  head: () => ({
    meta: [
      ...
      { title: "Diwakar Singh Rajbanshi — Full-Stack Developer" },
      {
        name: "description",
        content:
          "Jhapa-based full-stack developer building high-performance web applications with obsessive attention to detail.",
      },
      { name: "author", content: "Diwakar Singh Rajbanshi" },
      { property: "og:title", content: "Diwakar Singh Rajbanshi — Full-Stack Developer" },
      {
        property: "og:description",
        content: "Jhapa, Nepal-based full-stack developer. React · TypeScript · Node · Postgres.",
      },
